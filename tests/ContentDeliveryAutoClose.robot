...
Content delivery tasks to be auto closed
    [tags]                    Licenses
    [Documentation]           Auto-Completion of Task upon Content Delivery Submission SCMS-999
    Appstate                  Home
    Sleep                     1s
...
#Search the PR
    ...
    HoverText    /div[1]/div[1]/div[1]/div[1]/ul[1]/li[1]
    HoverText    New Task
    ClickText    New Task
    ClickText    Save
...
#delete the created task as clean-up
    VerifyText    Waiting for Content Delivery Details
    ClickText     Show more actions    anchor=This Month
